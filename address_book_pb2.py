...
_PERSON_PHONENUMBER_PHONETYPE = _descriptor.EnumDescriptor(
  name='PhoneType',
  full_name='Person.PhoneNumber.PhoneType',
  filename=None,
  file=DESCRIPTOR,
  values=[
